    ...
    <el-header class="header">
      <div class="header-left">
        <div class="logo">
          ...
          <span class="title">高校学生管理系统 - 教师</span>
        </div>
      </div>
...
<script>
import { Menu, ArrowDown, HomeFilled, Document, Timer, Ticket, Comment, Bell, User, Calendar } from '@element-plus/icons-vue'
    ...
    loadUserInfo() {
      try {
        ...
        if (userInfoStr) {
          ...
          console.log('教师Layout加载用户信息:', this.userInfo)
        } else {
