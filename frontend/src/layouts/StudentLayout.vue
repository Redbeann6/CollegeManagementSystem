    ...
    <el-header class="header">
      <div class="header-left">
        <div class="logo">
          ...
          <span class="title">高校学生管理系统 - 学生</span>
        </div>
      </div>
      <div class="header-right">
        <el-dropdown @command="handleCommand">
          <span class="user-info">
            ...
            <span class="user-name">{{ userInfo?.name || '学生' }}</span>
...
<script>
import { Menu, ArrowDown, HomeFilled, Document, Timer, Ticket, Comment, Bell, Calendar } from '@element-plus/icons-vue'
    ...
    loadUserInfo() {
      try {
        ...
        if (userInfoStr) {
          ...
          console.log('学生Layout加载用户信息:', this.userInfo)
        } else {
