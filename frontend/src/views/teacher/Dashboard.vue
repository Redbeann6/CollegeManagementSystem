<template>
  <div class="student-dashboard">
    <el-card class="welcome-card">
      <h1>欢迎回来，{{ studentInfo?.name || '教师' }}</h1>
  ...
  methods: {
    ...
    async initDashboard() {
      try {
        ...
        console.log('教师用户信息:', this.studentInfo)
    ...
    async fetchDashboardStats() {
      try {
        const response = await this.$axios.get('/teacher/dashboard', {
          headers: {
        ...
        if (response.data.success) {
          ...
          // 更新统计数据
          this.courseCount = data.coursesCount || 0;
          this.examCount = data.examsCount || 0;
          this.resultCount = data.resultsCount || 0;
          this.leaveCount = data.leaveRequestsCount || 0;
          this.studentCount = data.studentsCount || 0;
          this.ungradedCount = data.ungradedCount || 0;
