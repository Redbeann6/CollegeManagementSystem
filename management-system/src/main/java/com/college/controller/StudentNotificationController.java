    ...
    public ResponseEntity<Response<List<Object>>> getStudentNotifications(Authentication authentication) {
        try {
            ...
            if (currentUser instanceof Student) {
                ...
                org.springframework.data.domain.Page<com.college.dto.NotificationDTO> notifications = notificationService.findPublishedNotificationsForUser(student.getId(), pageable);
